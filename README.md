...
All internal IP addresses were changed from 192.168.2.1 to 192.168.50.1 and from 192.168.2.2 to 192.168.50.2. This was done to avoid conflicts with existing home networks. Please consider this when configuring PPPoE and all network-related functions.
...
git clone https://github.com/DaFunkShun/PI-Pwn
