...
echo '"'$PPPU'"  *  "'$PPPW'"  192.168.50.2' | sudo tee /etc/ppp/pap-secrets
while true; do
...
echo 'address=/manuals.playstation.net/192.168.50.1
...
address=/'$HSTN'.local/192.168.50.1' | sudo tee /etc/dnsmasq.more.conf
